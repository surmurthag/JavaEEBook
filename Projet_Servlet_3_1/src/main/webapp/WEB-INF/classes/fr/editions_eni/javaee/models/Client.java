...
public class Client  implements HttpSessionBindingListener, Serializable {
	...
	public void valueBound(HttpSessionBindingEvent event) {
		System.out.println("Liaison dans une session");
	}
	@Override
	public void valueUnbound(HttpSessionBindingEvent event) {
		System.out.println("Retrait d'une session");
	}
